  ...
  return (
    ...
    >
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full  max-xl:padding-x pt-28">
        ...
        <h1 className="mt-10 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-[82px] font-bold rounded-">
      ...
      xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-center">
        ...
        <div className="flex sm:gap-6 gap-4 absolute -bottom-[8%] sm:left-[15%] max-sm:px-6">
